...
base_model=MobileNetV2(input_shape=(IMAGE_WIDTH, IMAGE_HEIGHT,3), alpha = 0.35,include_top = False, weights = "imagenet"
...
class Callback(tf.keras.callbacks.Callback):
    def on_epoch_end(self,epoch, logs=None):
        "各エポック終了時に重みを保存する"
        mbnetModel.save("weight2.h5")

cb = Callback()
# 途中から学習する場合
initial_epoch = 0

#if os.path.isfile(os.path.join("weight2.h5")):    
#    mbnetModel.load_weights(os.path.join("weight2.h5"))
